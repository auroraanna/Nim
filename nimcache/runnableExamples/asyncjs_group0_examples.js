...
function nsuFindChar(s_973080091, sub_973080092, start_973080093, last_973080094) {
    var Temporary1;

  var result_973080095 = 0;
  ...
  BeforeRet: {
    ...
    F.line = 1902;
    if ((last_973080094 < 0)) {
    Temporary1 = (s_973080091).length - 1;
    }
    else {
    Temporary1 = last_973080094;
    }
    
    var last_973080096 = Temporary1;
    Label2: {
      F.line = 1905;
      var iHEX60gensym187_973080110 = 0;
      F.line = 75;
      var colontmp__956301423 = 0;
      F.line = 1905;
      colontmp__956301423 = start_973080093;
      F.line = 90;
      var res_956301424 = colontmp__956301423;
      Label3: {
        F.line = 91;
          Label4: while (true) {
          if (!(res_956301424 <= last_973080096)) break Label4;
            F.line = 1919;
            iHEX60gensym187_973080110 = res_956301424;
            if ((s_973080091[chckIndx(iHEX60gensym187_973080110, 0, (s_973080091).length - 1)] == sub_973080092)) {
            F.line = 1907;
            result_973080095 = iHEX60gensym187_973080110;
            break BeforeRet;
            }
  ...
  return result_973080095;

}

function nsuFindStrA(a_973080071, s_973080072, sub_973080073, start_973080074, last_973080075) {
    var Temporary1;

  var result_973080076 = 0;
  ...
  BeforeRet: {
    F.line = 1861;
    if ((last_973080075 < 0)) {
    Temporary1 = (s_973080072).length - 1;
    }
    else {
    Temporary1 = last_973080075;
    }
    
    var last_973080077 = Temporary1;
    F.line = 1862;
    var subLast_973080078 = subInt((sub_973080073).length, 1);
    if ((subLast_973080078 == -1)) {
    F.line = 1867;
    result_973080076 = start_973080074;
    break BeforeRet;
    }
    ...
    result_973080076 = -1;
    F.line = 1872;
    var skip_973080079 = start_973080074;
    Label2: {
      F.line = 1874;
        Label3: while (true) {
        if (!(subLast_973080078 <= subInt(last_973080077, skip_973080079))) break Label3;
          F.line = 1875;
          var i_973080080 = subLast_973080078;
          Label4: {
            F.line = 1876;
              Label5: while (true) {
              if (!(s_973080072[chckIndx(addInt(skip_973080079, i_973080080), 0, (s_973080072).length - 1)] == sub_973080073[chckIndx(i_973080080, 0, (sub_973080073).length - 1)])) break Label5;
                if ((i_973080080 == 0)) {
                F.line = 1878;
                result_973080076 = skip_973080079;
                break BeforeRet;
                }
                
                F.line = 1879;
                i_973080080 = subInt(i_973080080, 1);
              }
          };
          F.line = 1880;
          skip_973080079 = addInt(skip_973080079, a_973080071[chckIndx(s_973080072[chckIndx(addInt(skip_973080079, subLast_973080078), 0, (s_973080072).length - 1)], 0, (a_973080071).length - 1)]);
        }
    };
  };
  framePtr = F.prev;
...
function fill_973080030(a_973080032, value_973080033) {
  var F = {procname: "fill.fill", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/algorithm.nim", line: 0};
  framePtr = F;
    F.line = 72;
    var xHEX60gensym183_973080039 = 0;
    Label1: {
      F.line = 98;
        Label2: while (true) {
        if (!(xHEX60gensym183_973080039 <= (a_973080032).length - 1)) break Label2;
          F.line = 98;
          a_973080032[chckIndx(xHEX60gensym183_973080039, 0, (a_973080032).length - 1)] = value_973080033;
          F.line = 75;
          xHEX60gensym183_973080039 = addInt(xHEX60gensym183_973080039, 1);
        }
    };
  framePtr = F.prev;
...
function nsuInitSkipTable(a_973080027, sub_973080028) {
  var F = {procname: "strutils.initSkipTable", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
    F.line = 1834;
    var m_973080029 = (sub_973080028).length;
    F.line = 1835;
    fill_973080030(a_973080027, m_973080029);
    Label1: {
      F.line = 1837;
      var i_973080048 = 0;
      F.line = 117;
      ...
      F.line = 1837;
      colontmp__956301429 = subInt(m_973080029, 1);
      F.line = 119;
      var i_956301430 = 0;
      Label2: {
        F.line = 120;
          ...
          if (!(i_956301430 < colontmp__956301429)) break Label3;
            F.line = 1837;
            i_973080048 = i_956301430;
            F.line = 1837;
            a_973080027[chckIndx(sub_973080028[chckIndx(i_973080048, 0, (sub_973080028).length - 1)], 0, (a_973080027).length - 1)] = subInt(subInt(m_973080029, 1), i_973080048);
            F.line = 122;
...
function nsuInitNewSkipTable(sub_973080068) {
  var result_973080069 = [new Int32Array(256)];

  var F = {procname: "strutils.initSkipTable", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
    F.line = 1847;
    nsuInitSkipTable(result_973080069[0], sub_973080068);
  framePtr = F.prev;

  return result_973080069[0];

}

function nsuFindStr(s_973080128, sub_973080129, start_973080130, last_973080131) {
  var result_973080132 = 0;

  var F = {procname: "strutils.find", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    if ((subInt((s_973080128).length, start_973080130) < (sub_973080129).length)) {
    F.line = 1951;
    result_973080132 = -1;
    break BeforeRet;
    }
    
    if (((sub_973080129).length == 1)) {
    F.line = 1952;
    result_973080132 = nsuFindChar(s_973080128, sub_973080129[chckIndx(0, 0, (sub_973080129).length - 1)], start_973080130, last_973080131);
    break BeforeRet;
    }
    
    F.line = 1954;
    result_973080132 = nsuFindStrA(nsuInitNewSkipTable(sub_973080129), s_973080128, sub_973080129, start_973080130, last_973080131);
  };
  framePtr = F.prev;
...
function contains_973080261(s_973080262, sub_973080263) {
  var result_973080264 = false;

  var F = {procname: "strutils.contains", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: {
    F.line = 2092;
    result_973080264 = (0 <= nsuFindStr(s_973080262, sub_973080263, 0, -1));
    break BeforeRet;
  };
  framePtr = F.prev;

  return result_973080264;
...
function HEX3Aanonymous_956301378(r_956301379) {
  ...
  BeforeRet: {
    ...
    if (!(contains_973080261(cstrToNimstr(reason_956301345.message), [102,111,111,98,97,114,58,32,55]))) {
    F.line = 241;
