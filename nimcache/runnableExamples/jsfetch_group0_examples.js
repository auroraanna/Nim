...
function reprEnum(e_33557345, typ_33557346) {
  var result_33557347 = [];

  var F = {procname: "system.reprEnum", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/system/reprjs.nim", line: 0};
  framePtr = F;
    F.line = 28;
    var tmp_33557348 = false;
    F.line = 29;
    var item_33557349 = typ_33557346.node.sons[e_33557345];
    F.line = 30;
    tmp_33557348 = item_33557349 !== undefined
    if (tmp_33557348) {
    F.line = 32;
    result_33557347 = nimCopy(null, makeNimstrLit(item_33557349.name), NTI33554449);
    }
    else {
      F.line = 34;
      result_33557347 = nimCopy(null, (HEX24_352321544(e_33557345) || []).concat([32,40,105,110,118,97,108,105,100,32,100,97,116,97,33,41] || []), NTI33554449);
    }
    
  framePtr = F.prev;

  return result_33557347;
  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_637534619 < n_285212852)) break Label3;
            F.line = 49;
            iHEX60gensym4_285212867 = i_637534619;
            F.line = 49;
            ...
            F.line = 122;
            i_637534619 = addInt(i_637534619, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556520(f_33556521) {
  var result_33556522 = [[]];
    ...
    Label5: {
      var j_33556563 = 0;
      var colontmp__637534611 = 0;
      colontmp__637534611 = (i_33556531 - 1);
      var res_637534613 = colontmp__637534611;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_637534613)) break Label7;
            j_33556563 = res_637534613;
