  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_637534438 < n_285212852)) break Label3;
            F.line = 49;
            iHEX60gensym4_285212867 = i_637534438;
            F.line = 49;
            ...
            F.line = 122;
            i_637534438 = addInt(i_637534438, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556520(f_33556521) {
  var result_33556522 = [[]];
    ...
    Label5: {
      var j_33556563 = 0;
      var colontmp__637534430 = 0;
      colontmp__637534430 = (i_33556531 - 1);
      var res_637534432 = colontmp__637534430;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_637534432)) break Label7;
            j_33556563 = res_637534432;
...
function HEX3DHEX3D_637534221(x_637534223, y_637534224) {
  ...
  BeforeRet: {
    ...
    Label1: {
      ...
      var i_637534247 = 0;
      F.line = 75;
      var colontmp__637534423 = 0;
      F.line = 333;
      colontmp__637534423 = subInt((x_637534223).length, 1);
      F.line = 90;
      var res_637534425 = 0;
      Label2: {
        F.line = 91;
          Label3: while (true) {
          if (!(res_637534425 <= colontmp__637534423)) break Label3;
            F.line = 333;
            i_637534247 = res_637534425;
            ...
            F.line = 93;
            res_637534425 = addInt(res_637534425, 1);
          }
      };
    };
    F.line = 337;
